<?php
session_start(); // Démarrer la session pour accéder à la session de l'utilisateur
?>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="index.php">
        ...
        <span>Consulat de Guadeloupe</span>
    </a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <?php if (isset($_SESSION['user'])): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?page=profil" style="margin-right: 40px;">Bonjour, <?= htmlspecialchars($_SESSION['prenom']); ?></a>
                </li>
            <?php else: ?>
                <!-- Si l'utilisateur n'est pas connecté -->
                <li class="nav-item">
                    <a class="btn btn-outline-light mx-2" href="index.php?page=login">Se connecter</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-primary" href="index.php?page=inscription">S'inscrire</a>
                </li>
            <?php endif; ?>
        </ul>
    </div>
